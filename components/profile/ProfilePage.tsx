...
const expertiseData = {
    "Academic": ["Mathematics", "Physics", "Chemistry", "Biology", "Economics", "Statistics"],
    "Tech & Programming": ["Python", "JavaScript", "Java", "C++", "React", "Node.js", "Web Development", "Data Science", "App Development", "AI/ML"],
    "Design & Creative": ["CAD", "3D Modeling", "Graphic Design", "UI/UX", "Video Editing", "Photography"],
    "Languages": ["Spanish", "French", "German", "Mandarin", "Japanese", "Korean"],
    "Business & Finance": ["Marketing", "Finance", "Entrepreneurship", "Public Speaking", "Excel/Data Analysis"],
    "Life Skills": ["Cooking", "Fitness Training", "First Aid", "Time Management", "Study Techniques", "Music", "Guitar", "Writing"]
};
